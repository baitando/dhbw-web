describe("calculations", function () {
    ...
    it('should correctly sum up two values which can be converted to number', function () {
...
describe("persistence", function () {
    ...
    */
    it('should correctly save to local storage', function () {
        const key = "calculation";
        localStorage.removeItem(key);
        saveCalculation(2, 5, 7, key);

        expect(JSON.parse(localStorage.getItem(key))).to.deep.equal(
            {
                a: 2,
                b: 5,
                result: 7
